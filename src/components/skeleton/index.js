            ...
            <>
                ...
                <div className="container mx-auto flex flex-col justify-between lg:flex-row gap-16 lg:items-center">
                    <div className="flex flex-col gap-6 lg:w-2/4">
                        <div
                            role="status"
                            class="flex items-center justify-center h-[42rem] bg-gray-300 rounded-lg animate-pulse dark:bg-gray-700"
                        >
                            <svg
...
//                     <div className="grid grid-cols-1 gap-4 md:grid-cols-3 gap-4 lg:grid-cols-5 gap-4">
//                     <div className="grid overflow-hidden text-gray-700 bg-gray-300 bg-clip-border rounded-full place-items-center h-56 animate-pulse">
//                                     <svg
//                                         xmlns="http://www.w3.org/2000/svg"
//                                         fill="none"
//                                         viewBox="0 0 24 24"
...
//                     <div className="grid grid-cols-1 gap-4 md:grid-cols-3 gap-4 lg:grid-cols-3 gap-4">
//                         <div className="">
//                             <div className="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-80 animate-pulse">
//                                 <div className="relative grid h-56 mx-4 mt-4 overflow-hidden text-gray-700 bg-gray-300 bg-clip-border rounded-xl place-items-center">
//                                     <svg
//                                         xmlns="http://www.w3.org/2000/svg"
//                                         fill="none"
