                    ...
                    <div className="max-w-sm">
                        <div className="bg-white relative transition duration-500 rounded-lg">
                            <div className="item">
                                <div className="img_sp zoom_hinh">
                                    <div className="image-container">
                                        <a href={`/san-pham/${tenkhongdauvi}`} title={tenkhongdauvi}>
                                            <img
                            ...
                            <div className="rounded-lg bg-white">
                                ...
                                {giamoi > 0 ? (
                                    <p className="gia_sp">
                                        <span className="gia giamoi">{formatNumber(giamoi)} đ</span>
                                        <span className=" giacu">{formatNumber(gia)} đ</span>
                                    </p>
                                ) : (
                                    <p className="gia_sp">
                                        <span className="gia giamoi">{formatNumber(gia)} đ</span>
                                    </p>
                                )}
                                <div className="flex justify-center">
                                    {moi > 0 && (
                                        <span className="border rounded p-1 border-green-500 text-green-500">New</span>
                                    )}
                                </div>
                                <div className="mt-2">
                                    <div className="text-gray-500 text-xs">
                                        {title.daban} {formatNumber(daban)}
                                    </div>
                                </div>
                            </div>
